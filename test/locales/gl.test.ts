...
describe('locale gl', () => {
  ...
  it.each([
    { hour: 0, expected: '[hoxe ás] LT' },
    { hour: 1, expected: '[hoxe á] LT' },
  ...
  it.each([
    { hour: 0, expected: '[mañá ás] LT' },
    { hour: 1, expected: '[mañá á] LT' },
  ...
  it.each([
    { hour: 0, expected: 'dddd [ás] LT' },
    { hour: 1, expected: 'dddd [a] LT' },
  ...
  it.each([
    { hour: 0, expected: '[onte á] LT' },
    { hour: 1, expected: '[onte a] LT' },
  ...
  it.each([
    { hour: 0, expected: '[o] dddd [pasado ás] LT' },
    { hour: 1, expected: '[o] dddd [pasado a] LT' },
