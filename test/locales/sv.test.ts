...
describe('locale sv', () => {
  ...
  it('should have a method named "ordinal"', () => {
    ...
    expect(locale.ordinal(1)).toBe('1a')
    expect(locale.ordinal(2)).toBe('2a')
    expect(locale.ordinal(3)).toBe('3e')
    expect(locale.ordinal(12)).toBe('12a')
    expect(locale.ordinal(13)).toBe('13e')
  })
