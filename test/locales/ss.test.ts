...
import locale from '~/locales/ss'

describe('locale ss', () => {
  it('should have the correct name', () => {
    expect(locale.name).toBe('ss')
  })
  ...
  it('should have a method named "meridiem"', () => {
    ...
    expect(locale.meridiem(10, 0, false)).toBe('ekuseni')
    expect(locale.meridiem(14, 0, true)).toBe('emini')
    expect(locale.meridiem(18, 0, false)).toBe('entsambama')
    expect(locale.meridiem(20, 0, true)).toBe('ebusuku')
  })
})
