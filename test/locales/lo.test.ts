...
import locale from '~/locales/lo'

describe('locale lo', () => {
  it('should have the correct name', () => {
    expect(locale.name).toBe('lo')
  })
  ...
  it('should have a method named "meridiem"', () => {
    ...
    expect(locale.meridiem(10, 0, false)).toBe('ຕອນເຊົ້າ')
    expect(locale.meridiem(10, 0, true)).toBe('ຕອນເຊົ້າ')
    expect(locale.meridiem(20, 0, false)).toBe('ຕອນແລງ')
    expect(locale.meridiem(20, 0, true)).toBe('ຕອນແລງ')
  })
})
