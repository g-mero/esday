...
describe('locale uk', () => {
  ...
  it.each([
    ...
    ({ weekday, currentHour, expected }) => {
      const referenceDate = { hour: () => currentHour, day: () => weekday } as EsDay
  ...
  it.each([
    ...
    { token: 'ss', value: 2, noSuffix: false, key: 'ss', future: false, expected: '2 секунди' },
    { token: 'ss', value: 15, noSuffix: false, key: 'ss', future: true, expected: '15 секунд' },
    { token: 'ss', value: 36, noSuffix: false, key: 'ss', future: false, expected: '36 секунд' },
    { token: 'ss', value: 1, noSuffix: true, key: 'ss', future: false, expected: '1 секунда' },
    { token: 'ss', value: 2, noSuffix: true, key: 'ss', future: true, expected: '2 секунди' },
    { token: 'ss', value: 15, noSuffix: true, key: 'ss', future: false, expected: '15 секунд' },
    { token: 'ss', value: 36, noSuffix: true, key: 'ss', future: true, expected: '36 секунд' },
    { token: 'm', value: 1, noSuffix: false, key: 'm', future: false, expected: 'хвилину' },
    { token: 'm', value: 1, noSuffix: true, key: 'm', future: false, expected: 'хвилина' },
    { token: 'm', value: 1, noSuffix: false, key: 'm', future: true, expected: 'хвилину' },
    { token: 'm', value: 1, noSuffix: true, key: 'm', future: true, expected: 'хвилина' },
    { token: 'mm', value: 1, noSuffix: false, key: 'mm', future: false, expected: '1 хвилину' },
    { token: 'mm', value: 2, noSuffix: false, key: 'mm', future: false, expected: '2 хвилини' },
    { token: 'mm', value: 15, noSuffix: false, key: 'mm', future: true, expected: '15 хвилин' },
    { token: 'mm', value: 36, noSuffix: false, key: 'mm', future: false, expected: '36 хвилин' },
    { token: 'mm', value: 1, noSuffix: true, key: 'mm', future: false, expected: '1 хвилина' },
    { token: 'mm', value: 2, noSuffix: true, key: 'mm', future: true, expected: '2 хвилини' },
    { token: 'mm', value: 15, noSuffix: true, key: 'mm', future: false, expected: '15 хвилин' },
    { token: 'mm', value: 36, noSuffix: true, key: 'mm', future: true, expected: '36 хвилин' },
    { token: 'h', value: 1, noSuffix: false, key: 'h', future: false, expected: 'годину' },
    { token: 'h', value: 1, noSuffix: true, key: 'h', future: false, expected: 'година' },
    { token: 'h', value: 1, noSuffix: false, key: 'h', future: true, expected: 'годину' },
    { token: 'h', value: 1, noSuffix: true, key: 'h', future: true, expected: 'година' },
    { token: 'hh', value: 1, noSuffix: false, key: 'hh', future: false, expected: '1 годину' },
    { token: 'hh', value: 2, noSuffix: false, key: 'hh', future: false, expected: '2 години' },
    { token: 'hh', value: 15, noSuffix: false, key: 'hh', future: true, expected: '15 годин' },
    { token: 'hh', value: 23, noSuffix: false, key: 'hh', future: false, expected: '23 години' },
    { token: 'hh', value: 1, noSuffix: true, key: 'hh', future: false, expected: '1 година' },
    { token: 'hh', value: 2, noSuffix: true, key: 'hh', future: true, expected: '2 години' },
    { token: 'hh', value: 15, noSuffix: true, key: 'hh', future: true, expected: '15 годин' },
    { token: 'hh', value: 23, noSuffix: true, key: 'hh', future: true, expected: '23 години' },
    { token: 'dd', value: 1, noSuffix: false, key: 'dd', future: false, expected: '1 день' },
    { token: 'dd', value: 2, noSuffix: true, key: 'dd', future: false, expected: '2 дні' },
    { token: 'dd', value: 15, noSuffix: false, key: 'dd', future: true, expected: '15 днів' },
    { token: 'dd', value: 23, noSuffix: true, key: 'dd', future: true, expected: '23 дні' },
    { token: 'MM', value: 1, noSuffix: false, key: 'MM', future: false, expected: '1 місяць' },
    { token: 'MM', value: 2, noSuffix: true, key: 'MM', future: false, expected: '2 місяці' },
    { token: 'MM', value: 15, noSuffix: false, key: 'MM', future: true, expected: '15 місяців' },
    { token: 'MM', value: 23, noSuffix: true, key: 'MM', future: true, expected: '23 місяці' },
    { token: 'yy', value: 1, noSuffix: false, key: 'yy', future: false, expected: '1 рік' },
    { token: 'yy', value: 2, noSuffix: true, key: 'yy', future: false, expected: '2 роки' },
    { token: 'yy', value: 15, noSuffix: false, key: 'yy', future: true, expected: '15 років' },
    { token: 'yy', value: 23, noSuffix: true, key: 'yy', future: true, expected: '23 роки' },
  ])(
