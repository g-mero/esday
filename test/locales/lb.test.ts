...
describe('locale lb', () => {
  ...
  it.each([
    ...
    { token: 'future', value: -1, noSuffix: false, key: '', future: false, expected: 'a -1' },
    { token: 'future', value: 1, noSuffix: false, key: '', future: false, expected: 'an 1' },
    { token: 'future', value: 4, noSuffix: false, key: '', future: false, expected: 'a 4' },
    { token: 'future', value: 8, noSuffix: false, key: '', future: false, expected: 'an 8' },
    { token: 'future', value: 70, noSuffix: false, key: '', future: false, expected: 'a 70' },
    { token: 'future', value: 71, noSuffix: false, key: '', future: false, expected: 'an 71' },
    { token: 'future', value: 123, noSuffix: false, key: '', future: false, expected: 'an 123' },
    { token: 'future', value: 1234, noSuffix: false, key: '', future: false, expected: 'an 1234' },
    {
      token: 'future',
      value: '12 34',
      noSuffix: false,
    ...
    { token: 'past', value: -1, noSuffix: false, key: '', future: false, expected: 'viru -1' },
    { token: 'past', value: 1, noSuffix: false, key: '', future: false, expected: 'virun 1' },
    { token: 'past', value: 4, noSuffix: false, key: '', future: false, expected: 'viru 4' },
    { token: 'past', value: 8, noSuffix: false, key: '', future: false, expected: 'virun 8' },
    { token: 'past', value: 70, noSuffix: false, key: '', future: false, expected: 'viru 70' },
    { token: 'past', value: 71, noSuffix: false, key: '', future: false, expected: 'virun 71' },
    { token: 'past', value: 123, noSuffix: false, key: '', future: false, expected: 'virun 123' },
    { token: 'past', value: 1234, noSuffix: false, key: '', future: false, expected: 'virun 1234' },
    {
      token: 'past',
      value: '12 34',
      noSuffix: false,
    ...
    { token: 'm', value: 1, noSuffix: false, key: 'm', future: false, expected: '1enger Minutt' },
    { token: 'm', value: 1, noSuffix: true, key: 'm', future: false, expected: '1eng Minutt' },
    { token: 'm', value: 1, noSuffix: false, key: 'm', future: true, expected: '1enger Minutt' },
    { token: 'm', value: 1, noSuffix: true, key: 'm', future: true, expected: '1eng Minutt' },
    { token: 'h', value: 1, noSuffix: false, key: 'h', future: false, expected: '1enger Stonn' },
    { token: 'h', value: 1, noSuffix: true, key: 'h', future: false, expected: '1eng Stonn' },
    { token: 'h', value: 1, noSuffix: false, key: 'h', future: true, expected: '1enger Stonn' },
    { token: 'h', value: 1, noSuffix: true, key: 'h', future: true, expected: '1eng Stonn' },
    { token: 'd', value: 1, noSuffix: false, key: 'd', future: false, expected: '1engem Dag' },
    { token: 'd', value: 1, noSuffix: true, key: 'd', future: false, expected: '1een Dag' },
    { token: 'd', value: 1, noSuffix: false, key: 'd', future: true, expected: '1engem Dag' },
    { token: 'd', value: 1, noSuffix: true, key: 'd', future: true, expected: '1een Dag' },
    { token: 'M', value: 1, noSuffix: false, key: 'M', future: false, expected: '1engem Mount' },
    { token: 'M', value: 1, noSuffix: true, key: 'M', future: false, expected: '1ee Mount' },
    { token: 'M', value: 1, noSuffix: false, key: 'M', future: true, expected: '1engem Mount' },
    { token: 'M', value: 1, noSuffix: true, key: 'M', future: true, expected: '1ee Mount' },
    { token: 'y', value: 1, noSuffix: false, key: 'y', future: false, expected: '1engem Joer' },
    { token: 'y', value: 1, noSuffix: true, key: 'y', future: false, expected: '1ee Joer' },
    { token: 'y', value: 1, noSuffix: false, key: 'y', future: true, expected: '1engem Joer' },
    { token: 'y', value: 1, noSuffix: true, key: 'y', future: true, expected: '1ee Joer' },
  ])(
