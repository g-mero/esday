...
describe('locale hr', () => {
  ...
  it.each([
    { token: 'ss', value: 11, noSuffix: false, key: 's', future: false, expected: '' }, // test for unknown token
    { token: 'ss', value: 1, noSuffix: false, key: 'ss', future: false, expected: '1 sekunda' },
    { token: 'ss', value: 2, noSuffix: false, key: 'ss', future: false, expected: '2 sekunde' },
    { token: 'ss', value: 5, noSuffix: false, key: 'ss', future: false, expected: '5 sekundi' },
    { token: 'ss', value: 11, noSuffix: true, key: 'ss', future: false, expected: '11 sekundi' },
    { token: 'ss', value: 25, noSuffix: false, key: 'ss', future: true, expected: '25 sekundi' },
    { token: 'm', value: 1, noSuffix: false, key: 'm', future: false, expected: 'jedne minute' },
    { token: 'm', value: 2, noSuffix: false, key: 'm', future: false, expected: 'jedne minute' },
    { token: 'm', value: 1, noSuffix: true, key: 'm', future: false, expected: 'jedna minuta' },
    { token: 'm', value: 2, noSuffix: true, key: 'm', future: true, expected: 'jedna minuta' },
    { token: 'mm', value: 1, noSuffix: false, key: 'mm', future: false, expected: '1 minuta' },
    { token: 'mm', value: 2, noSuffix: false, key: 'mm', future: false, expected: '2 minute' },
    { token: 'mm', value: 5, noSuffix: false, key: 'mm', future: false, expected: '5 minuta' },
    { token: 'mm', value: 11, noSuffix: true, key: 'mm', future: false, expected: '11 minuta' },
    { token: 'mm', value: 24, noSuffix: false, key: 'mm', future: true, expected: '24 minuta' },
    { token: 'mm', value: 36, noSuffix: true, key: 'mm', future: true, expected: '36 minuta' },
    { token: 'h', value: 1, noSuffix: false, key: 'h', future: false, expected: 'jednog sata' },
    { token: 'h', value: 2, noSuffix: true, key: 'h', future: false, expected: 'jedan sat' },
    { token: 'h', value: 1, noSuffix: false, key: 'h', future: true, expected: 'jednog sata' },
    { token: 'h', value: 3, noSuffix: true, key: 'h', future: true, expected: 'jedan sat' },
    { token: 'hh', value: 1, noSuffix: false, key: 'hh', future: false, expected: '1 sat' },
    { token: 'hh', value: 2, noSuffix: false, key: 'hh', future: false, expected: '2 sata' },
    { token: 'hh', value: 5, noSuffix: false, key: 'hh', future: false, expected: '5 sati' },
    { token: 'hh', value: 1, noSuffix: true, key: 'hh', future: false, expected: '1 sat' },
    { token: 'hh', value: 2, noSuffix: false, key: 'hh', future: true, expected: '2 sata' },
    { token: 'hh', value: 6, noSuffix: true, key: 'hh', future: true, expected: '6 sati' },
    { token: 'dd', value: 11, noSuffix: false, key: 'd', future: false, expected: '' }, // test for unknown token
    { token: 'dd', value: 1, noSuffix: false, key: 'dd', future: false, expected: '1 dan' },
    { token: 'dd', value: 2, noSuffix: false, key: 'dd', future: false, expected: '2 dana' },
    { token: 'dd', value: 5, noSuffix: true, key: 'dd', future: false, expected: '5 dana' },
    { token: 'dd', value: 1, noSuffix: false, key: 'dd', future: true, expected: '1 dan' },
    { token: 'dd', value: 4, noSuffix: true, key: 'dd', future: true, expected: '4 dana' },
    { token: 'MM', value: 3, noSuffix: false, key: 'M', future: false, expected: '' }, // test for unknown token
    { token: 'MM', value: 1, noSuffix: false, key: 'MM', future: false, expected: '1 mjesec' },
    { token: 'MM', value: 2, noSuffix: false, key: 'MM', future: false, expected: '2 mjeseca' },
    { token: 'MM', value: 3, noSuffix: false, key: 'MM', future: true, expected: '3 mjeseca' },
    { token: 'MM', value: 4, noSuffix: true, key: 'MM', future: false, expected: '4 mjeseca' },
    { token: 'MM', value: 5, noSuffix: false, key: 'MM', future: false, expected: '5 mjeseci' },
    { token: 'MM', value: 6, noSuffix: true, key: 'MM', future: true, expected: '6 mjeseci' },
    { token: 'MM', value: 7, noSuffix: true, key: 'MM', future: true, expected: '7 mjeseci' },
    { token: 'MM', value: 8, noSuffix: true, key: 'MM', future: true, expected: '8 mjeseci' },
    { token: 'MM', value: 19, noSuffix: true, key: 'MM', future: true, expected: '19 mjeseci' },
    { token: 'yy', value: 1, noSuffix: false, key: 'y', future: false, expected: '' }, // test for unknown token
    { token: 'yy', value: 1, noSuffix: false, key: 'yy', future: false, expected: '1 godina' },
    { token: 'yy', value: 2, noSuffix: false, key: 'yy', future: false, expected: '2 godine' },
    { token: 'yy', value: 3, noSuffix: false, key: 'yy', future: true, expected: '3 godine' },
    { token: 'yy', value: 4, noSuffix: true, key: 'yy', future: false, expected: '4 godine' },
    { token: 'yy', value: 5, noSuffix: false, key: 'yy', future: false, expected: '5 godina' },
    { token: 'yy', value: 6, noSuffix: true, key: 'yy', future: true, expected: '6 godina' },
  ])(
