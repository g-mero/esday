...
describe('locale pl', () => {
  ...
  it.each([
    { token: 'ss', value: 1, noSuffix: false, key: 'ss', future: false, expected: '1 sekund' },
    { token: 'ss', value: 2, noSuffix: true, key: 'ss', future: false, expected: '2 sekundy' },
    { token: 'ss', value: 11, noSuffix: false, key: 'ss', future: true, expected: '11 sekund' },
    { token: 'ss', value: 22, noSuffix: true, key: 'ss', future: true, expected: '22 sekundy' },
    { token: 'm', value: 1, noSuffix: false, key: 'm', future: false, expected: 'minutę' },
    { token: 'm', value: 2, noSuffix: true, key: 'm', future: false, expected: 'minuta' },
    { token: 'm', value: 11, noSuffix: false, key: 'm', future: true, expected: 'minutę' },
    { token: 'm', value: 22, noSuffix: true, key: 'm', future: true, expected: 'minuta' },
    ...
    { token: 'mm', value: 11, noSuffix: false, key: 'mm', future: true, expected: '11 minut' },
    { token: 'mm', value: 22, noSuffix: true, key: 'mm', future: true, expected: '22 minuty' },
    { token: 'h', value: 1, noSuffix: false, key: 'h', future: false, expected: 'godzinę' },
    { token: 'h', value: 2, noSuffix: true, key: 'h', future: false, expected: 'godzina' },
    { token: 'h', value: 11, noSuffix: false, key: 'h', future: true, expected: 'godzinę' },
    { token: 'h', value: 22, noSuffix: true, key: 'h', future: true, expected: 'godzina' },
    { token: 'hh', value: 1, noSuffix: false, key: 'hh', future: false, expected: '1 godzin' },
    { token: 'hh', value: 2, noSuffix: true, key: 'hh', future: false, expected: '2 godziny' },
    { token: 'hh', value: 11, noSuffix: false, key: 'hh', future: true, expected: '11 godzin' },
    { token: 'hh', value: 22, noSuffix: true, key: 'hh', future: true, expected: '22 godziny' },
    { token: 'MM', value: 1, noSuffix: false, key: 'MM', future: false, expected: '1 miesięcy' },
    { token: 'MM', value: 2, noSuffix: true, key: 'MM', future: false, expected: '2 miesiące' },
    { token: 'MM', value: 11, noSuffix: false, key: 'MM', future: true, expected: '11 miesięcy' },
    { token: 'MM', value: 22, noSuffix: true, key: 'MM', future: true, expected: '22 miesiące' },
    { token: 'yy', value: 1, noSuffix: false, key: 'yy', future: false, expected: '1 lat' },
    { token: 'yy', value: 2, noSuffix: true, key: 'yy', future: false, expected: '2 lata' },
    { token: 'yy', value: 11, noSuffix: false, key: 'yy', future: true, expected: '11 lat' },
    { token: 'yy', value: 22, noSuffix: true, key: 'yy', future: true, expected: '22 lata' },
