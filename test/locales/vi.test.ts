...
import locale from '~/locales/vi'

describe('locale vi', () => {
  it('should have the correct name', () => {
    expect(locale.name).toBe('vi')
  })
  ...
  it('should have a method named "meridiem"', () => {
    ...
    expect(locale.meridiem(10, 0, false)).toBe('SA')
    expect(locale.meridiem(10, 0, true)).toBe('sa')
    expect(locale.meridiem(20, 0, false)).toBe('CH')
    expect(locale.meridiem(20, 0, true)).toBe('ch')
  })
})
