...
import locale from '~/locales/my'

describe('locale my', () => {
  it('should have the correct name', () => {
    expect(locale.name).toBe('my')
  })
