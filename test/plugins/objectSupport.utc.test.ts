...
import { objectSupportPlugin, utcPlugin } from '~/plugins'
...
describe('objectSupport plugin with utc - default cases', () => {
  ...
  it.each([
    ...
    { value: { h: 14, m: 25, s: 36 }, expected: '14:25:36', description: 'h-m-s' },
  ])('create date from object with short format "$description"', ({ value, expected }) => {
  ...
  it.each([
    ...
    {
      value: { year: 2024, month: 4, day: 14, hour: 15, minute: 13, second: 34 },
      expected: '2024-05-14T15:13:34',
      description: 'y-M-D-h-m-s',
    },
    {
      value: { year: 2024, month: 4, date: 14, hour: 15, minute: 13, second: 34 },
      expected: '2024-05-14T15:13:34',
      description: 'y-M-d-h-m-s',
    },
  ...
  it.each([
    ...
    { value: { hour: 14, minute: 25, second: 36 }, expected: '14:25:36', description: 'h-m-s' },
  ])('create date from object with long format "$description"', ({ value, expected }) => {
    expect(esday.utc(value).format().slice(11, 19)).toBe(expected)
    expect(moment.utc(value).format().slice(11, 19)).toBe(expected)
  })
  ...
  it.each([
    ...
    {
      value: { years: 2024, months: 4, days: 14, hours: 15, minutes: 13, seconds: 34 },
      expected: '2024-05-14T15:13:34',
      description: 'y-M-D-h-m-s',
    },
    {
      value: { years: 2024, months: 4, dates: 14, hours: 15, minutes: 13, seconds: 34 },
      expected: '2024-05-14T15:13:34',
      description: 'y-M-d-h-m-s',
    },
  ...
  it.each([
    ...
    { value: { hours: 14, minutes: 25, seconds: 36 }, expected: '14:25:36', description: 'h-m-s' },
  ])('create date from object with plural format "$description"', ({ value, expected }) => {
    expect(esday.utc(value).format().slice(11, 19)).toBe(expected)
    expect(moment.utc(value).format().slice(11, 19)).toBe(expected)
  })
  ...
  it.each([
    ...
    { value: { years: 1, month: 2 }, expected: '2026-09-17T03:24:46', description: 'y-M' },
    {
    ...
    { value: { hours: 1, minutes: 2 }, expected: '2025-07-17T04:26:46', description: 'h-m' },
    {
  ...
  it.each([
    ...
    { value: { hours: 1, minutes: -2 }, expected: '2025-07-17T02:26:46', description: 'h-m' },
    {
      value: { hours: 1, minutes: 2, seconds: 3 },
  ...
  it.each([
    { value: { year: 2024 }, expected: '2024-07-17T03:24:46', description: 'y' },
    ...
    { value: { year: 2026, month: 4 }, expected: '2026-05-17T03:24:46', description: 'y-M' },
    {
    ...
    { value: { hour: 2, minute: 26 }, expected: '2025-07-17T02:26:46', description: 'h-m' },
    {
    ...
    {
      value: { year: 2024, month: 4, date: 14, hour: 2, minute: 22, second: 43 },
      expected: '2024-05-14T02:22:43',
      description: 'all',
    },
    { value: {}, expected: '2025-07-17T03:24:46', description: 'none' },
