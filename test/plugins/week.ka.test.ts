...
describe('week plugin - locale "ka"', () => {
  ...
  it.each([
    ...
    { sourceString: '2024 12 24 სა 14:25:36', formatString: 'YYYY MM DD dd HH:mm:ss' },
    { sourceString: '2024 12 24 სამ 14:25:36', formatString: 'YYYY MM DD ddd HH:mm:ss' },
    { sourceString: '2024 12 24 სამშაბათი 14:25:36', formatString: 'YYYY MM DD dddd HH:mm:ss' },
